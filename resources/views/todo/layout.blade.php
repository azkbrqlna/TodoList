...
<body class="bg-dark">
    ...
    {{-- <nav class="navbar navbar-expand-lg navbar-dark bg-light">
        <div class="container-fluid col-md-7">
            <div class="navbar-brand text-black">To Do List</div>
            <!--
    ...
    <div class="container mt-4">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card mb-3">
                    <div class="card-body">
                        {{-- untuk menampilkan error pada laravel --}}
                        @if ($errors->any())
                        ...
                        <form id="todo-form" action="{{ route('todo.post') }}" method="post">
                            ...
                            <div class="input-group mb-3">
                                {{-- old('name')  untuk mengambil data lama --}}
                        ...
                        <ul class="list-group mb-4" id="todo-list">
                            ...
                            @foreach ($data as $item)
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    @if ($item->completed === 1)
                                        <span class="task-text text-decoration-line-through">{{ $item->task }}</span>
                                    @else
                                            ...
                                            <div class="radio px-2">
                                                <label>
                                                    <input type="radio" value="1" name="completed"
                                                        {{ $item->completed == 1 ? 'checked' : '' }}> Selesai
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" value="0" name="completed"
                                                        {{ $item->completed == 0 ? 'checked' : '' }}> Belum
                                                </label>
                                            </div>
                                        </div>
                                    </form>
